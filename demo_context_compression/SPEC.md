# Specification: Context Compression

- Blueprint id: `demo_context_compression`
- Standard: `1.0`
- Primary runtime feature: `CompileContext compression`
- Scenario: Compress a context packet while preserving goals and source references.
