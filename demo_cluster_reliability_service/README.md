# Demo: Cluster Reliability Service

`Blueprint ID:` `demo_cluster_reliability_service`
`Category:` `Engineering`

Use this blueprint to test and demo advanced cluster reliability management with Nomad-inspired scheduling, lifecycle, recovery, drain, and service-discovery controls.
...
```bash
mn run demo_cluster_reliability_service
```
...
Run from the catalog with `mn run demo_cluster_reliability_service` or from this folder with `mn run --folder .`.
