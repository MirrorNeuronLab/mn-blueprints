# Specification: Retry Recovery

- Blueprint id: `demo_retry_recovery`
- Standard: `1.0`
- Primary runtime feature: `Step retry policy`
- Scenario: Fail attempt one and succeed on attempt two through the durable ledger.
