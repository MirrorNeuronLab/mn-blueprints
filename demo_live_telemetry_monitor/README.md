# Demo: Live Telemetry Monitor

`Blueprint ID:` `demo_live_telemetry_monitor`
`Category:` `Engineering`

Use this blueprint to process live telemetry chunks, detect changing signal patterns, and summarize what operators need to notice.
...
```bash
mn run demo_live_telemetry_monitor
```
...
Run from the catalog with `mn run demo_live_telemetry_monitor` or from this folder with `mn run --folder .`.
