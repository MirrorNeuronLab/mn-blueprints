# State Audit Simulation

`Blueprint ID:` `state_audit_simulation`
...
Run from the catalog with `mn run state_audit_simulation` or from this folder with `mn run --folder .`.
