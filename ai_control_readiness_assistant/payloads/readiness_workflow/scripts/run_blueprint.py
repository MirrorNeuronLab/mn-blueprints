...
BLUEPRINT_ID = "ai_control_readiness_assistant"
BLUEPRINT_NAME = "AI Control Readiness Assistant"
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "AI Control Readiness Assistant",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AI Control Readiness Assistant blueprint.")
