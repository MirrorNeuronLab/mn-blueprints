# Ecosystem Intervention Sandbox SPEC
...
The blueprint is organized as a MirrorNeuron workflow with stable identity, configurable inputs, structured events, and a final artifact. The main agent role is World coordinator, regional agents, leaderboard summarizer. The workflow uses multi-region population dynamics and demonstrates native agents, multi-region simulation, aggregation, and leaderboard reporting.
