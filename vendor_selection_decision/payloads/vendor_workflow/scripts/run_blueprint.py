...
BLUEPRINT_ID = "vendor_selection_decision"
BLUEPRINT_NAME = "Vendor Selection Decision"
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "Vendor Selection Decision",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the Vendor Selection Decision blueprint.")
