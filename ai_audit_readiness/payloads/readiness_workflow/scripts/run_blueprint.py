...
BLUEPRINT_ID = "ai_audit_readiness"
BLUEPRINT_NAME = "AI Audit Readiness"
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "AI Audit Readiness",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AI Audit Readiness blueprint.")
