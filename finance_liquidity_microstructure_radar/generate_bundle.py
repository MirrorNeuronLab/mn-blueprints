...
def build_manifest(args: argparse.Namespace) -> dict:
    ...
    return {
        ...
        "graph_id": "finance_liquidity_microstructure_radar_v1",
        "job_name": "finance_liquidity_microstructure_radar",
        ...
        "initial_inputs": {
            "ingress": [
                {
                    "scenario": "finance_market_realtime_advisor",
                    "tick_seconds": args.tick_seconds,
                    "seed": args.seed,
                    "slack_optional": True,
                }
...
def main() -> None:
    ...
    parser.add_argument("--litellm-model", default="ollama/nemotron3:33b")
    ...
    log_status(
        "finance_liquidity_microstructure_radar",
    ...
    write_manifest(
        ...
        build_manifest(args),
        blueprint_id="finance_liquidity_microstructure_radar",
        quick_test=quick_test,
    )
