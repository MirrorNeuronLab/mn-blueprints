# Demo: Policy Feedback Optimization

`Blueprint ID:` `demo_policy_feedback_optimization`
...
```bash
mn run demo_policy_feedback_optimization
```
...
Run from the catalog with `mn run demo_policy_feedback_optimization` or from this folder with `mn run --folder .`.
