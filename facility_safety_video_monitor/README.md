...
Facility Safety Video Monitor is a MirrorNeuron blueprint for continuous safety monitoring over facility video. It samples a live webcam or RTSP camera stream, asks a configurable vision-language model whether a human is visible, applies cooldown state, and writes reviewable alert artifacts.
