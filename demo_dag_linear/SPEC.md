# Specification: DAG Linear

- Blueprint id: `demo_dag_linear`
- Standard: `1.0`
- Primary runtime feature: `Linear DAG`
- Scenario: Parse, score, and report one support ticket in strict order.
