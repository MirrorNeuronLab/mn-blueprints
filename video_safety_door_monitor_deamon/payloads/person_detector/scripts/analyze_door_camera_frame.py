...
def post_slack(text: str) -> tuple[str, dict[str, Any]]:
    ...
    token = os.environ.get("MIRROR_NEURON_SLACK_BOT_TOKEN") or os.environ.get("SLACK_BOT_TOKEN")
    channel = os.environ.get("MIRROR_NEURON_SLACK_DEFAULT_CHANNEL") or os.environ.get("SLACK_DEFAULT_CHANNEL")
    if not enabled:
    ...
    api_url = os.environ.get("MIRROR_NEURON_SLACK_API_BASE_URL") or os.environ.get("SLACK_API_BASE_URL") or "https://slack.com/api/chat.postMessage"
