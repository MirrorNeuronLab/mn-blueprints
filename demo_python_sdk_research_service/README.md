# Demo: Python SDK Research Service

`Blueprint ID:` `demo_python_sdk_research_service`
`Category:` `Engineering`

Use this blueprint to run a Python-defined workflow as a long-lived research service with repeated stateful turns.
...
```bash
mn run demo_python_sdk_research_service
```
...
Run from the catalog with `mn run demo_python_sdk_research_service` or from this folder with `mn run --folder .`.
