# Specification: DAG Conditional Branch

- Blueprint id: `demo_dag_conditional_branch`
- Standard: `1.0`
- Primary runtime feature: `Conditional branching`
- Scenario: Route one transaction through exactly one risk branch and rejoin.
