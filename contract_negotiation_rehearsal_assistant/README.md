# Contract Negotiation Rehearsal Assistant

`Blueprint ID:` `contract_negotiation_rehearsal_assistant`
`Category:` `Engineering`

Use this blueprint to model buyer-supplier negotiation rounds and compare offers as demand, price, and capacity change.
...
```bash
mn run contract_negotiation_rehearsal_assistant
```
...
Run from the catalog with `mn run contract_negotiation_rehearsal_assistant` or from this folder with `mn run --folder .`.
