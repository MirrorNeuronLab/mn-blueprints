# Demo: Python SDK Research Pipeline

`Blueprint ID:` `demo_python_sdk_research_pipeline`
`Category:` `Engineering`

Use this blueprint to author a MirrorNeuron workflow directly in Python and compile it into a runnable blueprint bundle.
...
```bash
mn run demo_python_sdk_research_pipeline
```
...
Run from the catalog with `mn run demo_python_sdk_research_pipeline` or from this folder with `mn run --folder .`.
