...
are not used inside the simulation.
...
The result separates deterministic measurements from the model explanation:
...
- `final_artifact.json` — immutable simulation result plus explanation and caveats
