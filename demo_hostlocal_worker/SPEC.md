# Specification: Hostlocal Worker

- Blueprint id: `demo_hostlocal_worker`
- Standard: `1.0`
- Primary runtime feature: `HostLocal execution`
- Scenario: Normalize a small incident record in a HostLocal Python worker.
