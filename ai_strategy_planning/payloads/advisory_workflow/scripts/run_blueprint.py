...
BLUEPRINT_ID = "ai_strategy_planning"
BLUEPRINT_NAME = "AI Strategy Planning"
THEME_KEYWORDS = {
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "AI Strategy Planning",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AI Strategy Planning blueprint.")
