...
BLUEPRINT_ID = "ai_strategy_advisory_assistant"
BLUEPRINT_NAME = "AI Strategy Advisory Assistant"
THEME_KEYWORDS = {
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "AI Strategy Advisory Assistant",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AI Strategy Advisory Assistant blueprint.")
