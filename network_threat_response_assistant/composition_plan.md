...
Network Threat Response Assistant or hack behavior.

## Reference Blueprints

- user_activity_rmf_triage_assistant
- ai_control_readiness_assistant
...
- `mn-agents.control_join`: Reuse pattern observed in reference blueprint ai_control_readiness_assistant.
- `mn-agents.data_module`: Reuse pattern observed in reference blueprint facility_safety_monitor_assistant.
