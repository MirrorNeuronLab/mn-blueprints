...
| --- | --- | --- |
| `LITELLM_MODEL` | `ollama/nemotron3:33b` | Model name passed to LiteLLM or local Ollama fallback. |
| `LITELLM_API_BASE` | `http://192.168.4.173:11434` | Provider API base URL. For Ollama, use the Ollama server base. |
...
If not, it can call local Ollama directly for models like `ollama/nemotron3:33b`.
