# Specification: DAG Quorum

- Blueprint id: `demo_dag_quorum`
- Standard: `1.0`
- Primary runtime feature: `Quorum trigger`
- Scenario: Accept two successful sensor votes while one controlled vote fails.
