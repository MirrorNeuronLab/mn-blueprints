# Codebase Memory Compression Analysis

`Blueprint ID:` `codebase_memory_compression_analysis`
...
```bash
mn run codebase_memory_compression_analysis
```
...
Run from the catalog with `mn run codebase_memory_compression_analysis` or from this folder with `mn run --folder .`.
