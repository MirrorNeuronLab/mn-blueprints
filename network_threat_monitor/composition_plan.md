...
Network Threat Monitor or hack behavior.
...
- `mn-agents.control_join`: Reuse pattern observed in reference blueprint ai_audit_readiness.
- `mn-agents.data_module`: Reuse pattern observed in reference blueprint facility_safety_video_monitor.
