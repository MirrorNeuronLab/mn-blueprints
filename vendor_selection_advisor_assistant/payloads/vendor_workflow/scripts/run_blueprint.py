...
BLUEPRINT_ID = "vendor_selection_advisor_assistant"
BLUEPRINT_NAME = "Vendor Selection Advisor Assistant"
...
def run_workflow(inputs: dict[str, Any], *, contract: Any | None = None) -> dict[str, Any]:
    ...
    final_artifact = {
        ...
        "product_name": "Vendor Selection Advisor Assistant",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the Vendor Selection Advisor Assistant blueprint.")
